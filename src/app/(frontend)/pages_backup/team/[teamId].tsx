...
import { sampleTeamDetail } from '../../data/teams'
...
const TeamDetailPage = ({ teamId }: TeamDetailPageProps) => {
      ...
      <main className="container mx-auto max-w-6xl px-4 py-6 space-y-6">
        ...
        <div className="rounded-xl border border-base-300/50 bg-base-200 shadow-sm">
          <div className="px-3 py-2 border-b border-base-300/50 flex items-center justify-between bg-base-300/30">
            ...
            <span className="text-[11px] text-base-content/60">#{team.ranking}</span>
          </div>
          <div className="p-4">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
                  <div>
                    ...
                    <div className="flex items-center gap-4 text-sm text-base-content/70">
                      <span>#{team.ranking} no ranking mundial</span>
                      <span>•</span>
                      <span>{team.points.toLocaleString()} pontos</span>
                      <span>•</span>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                  <div>
                    ...
                    <div className="text-base-content font-medium">{team.founded}</div>
                  </div>
                  <div>
                    <div className="text-base-content/60 text-xs">Região</div>
                    <div className="text-base-content font-medium">{team.region}</div>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <div className="text-green-400 font-medium">{team.stats.winRate}%</div>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="rounded-xl border border-base-300/50 bg-base-200 shadow-sm">
                ...
                <div className="p-4">
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div className="text-center">
                      <div className="text-xl font-bold text-green-400">{team.stats.wins}</div>
                      <div className="text-xs text-base-content/60">Vitórias</div>
                    </div>
                    <div className="text-center">
                      <div className="text-xl font-bold text-red-400">{team.stats.losses}</div>
            ...
            <div className="space-y-6">
              ...
              <div className="rounded-xl border border-base-300/50 bg-base-200 shadow-sm">
                ...
                <div className="p-4">
                  ...
                  <div className="text-xs text-base-content/60">
                    {team.stats.wins}V - {team.stats.losses}D nos últimos 30 dias
                  </div>
                </div>
              </div>
            </div>
                ...
                <div className="p-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="text-xs text-base-content/70 space-y-1">
                      <div>Idade: {player.age} anos</div>
                      <div>País: {player.country}</div>
                      <div>
                        No time desde: {new Date(player.joinDate).toLocaleDateString('pt-BR')}
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex items-center gap-3">
                        <TeamLogo
                          team={{ name: match.opponent.name, logo: match.opponent.logo }}
                          size="sm"
                        />
                        <div>
